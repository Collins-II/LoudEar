        ...
        <div className="grid md:grid-cols-2 gap-5 h-hero-content-sm sm:h-hero-content sm:mt-14 grid-rows-3 md:grid-rows-1 box-border">
          <div className="flex flex-col relative row-span-2 md:row-span-1 justify-around py-10 md:py-0 md:justify-center gap-5">
            ...
            <p className="text-sm sm:text-base">
              Welcome to LoudEar Agency, your digital partner. We offer content
            ...
            <TrialButton
              ...
              dark={false}
            />
            <div className="md:absolute md:bottom-0 md:inset-x-0 flex sm:flex-row items-start justify-center *:w-full *:h-10 md:*:h-auto md:items-stretch md:h-16">
              <Greenish />
              <Automation />
