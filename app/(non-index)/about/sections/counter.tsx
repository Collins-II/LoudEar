    ...
    <section className="width-responsive py-10 flex justify-between gap-5 md:flex-row flex-col">
      <div className="flex flex-col items-center md:items-start gap-2 sm:gap-5">
        ...
        <p className="text-center md:text-start">
          LoudEar Agency has transformed the digital presence of numerous
      ...
      <div className="flex flex-col items-center md:items-start gap-2 sm:gap-5">
        ...
        <p className="text-center md:text-start">
          LoudEar Agency has brought numerous brands to life with our innovative
      ...
      <div className="flex flex-col items-center md:items-start gap-2 sm:gap-5">
        ...
        <p className="text-center md:text-start">
          LoudEar Agency has successfully amplified the online presence of
